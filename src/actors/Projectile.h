...
protected:
	...
	bool m_dead;				/* Indique si le projectile est √  supprimer */
	int m_life_span;
	dmg_chan m_chan;
	bool m_invincible;
...
public:
	...
	*/
	...
	/**
	 *	@brief Accesseur
	 *	@return Vrai si le Projectile doit etre supprim√©
	*/
