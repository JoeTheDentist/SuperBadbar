...
public:
	...
	Rect frame();	/* accesseur (m_frame) */
	void display_picture(SDL_Surface *pic, Rect *pos); /* ATTENTION: pos designe la position par rapport à la fenetre: m_frame n'est pas pris en compte dans cette fonction */
	void flip_camera();
