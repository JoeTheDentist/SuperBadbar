...
Dashboard::Dashboard()
{
	...
	m_weapons_pictures[MACHINEGUN] = SDL_LoadBMP("../pic/dashboard/heart.bmp");
	m_weapons_pictures[GUN] = SDL_LoadBMP("../pic/statics/black_board.bmp");
	m_weapons_pictures[SHOTGUN] = SDL_LoadBMP("../pic/dashboard/heart.bmp");
