...
public:
    ...
    */
    virtual void setStateBeingAdded()
    {
    ...
    *	@brief Mutateur d'etat
    */
    virtual void setStateBeingMoved()
    {
        m_state = e_beingMoved;
    }
